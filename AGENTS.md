# AGENTS.md — fanwaave/fanwaave-mcp-server.rs
...
- GitHub org: [`fanwaave`](https://github.com/fanwaave)
- Repository: [`fanwaave/fanwaave-mcp-server.rs`](https://github.com/fanwaave/fanwaave-mcp-server.rs)
- Local checkout: `~/codes/fanwaave/fanwaave-mcp-server.rs`
- Linear project: https://linear.app/denman/project/githubcomfanwaave-6ba038b59dbc
- GitHub org project: https://github.com/orgs/fanwaave/projects/1
- Sibling test org: `github.com/fanwaave-test` (external/e2e coverage and extra GHA minutes)
...
- Package / service name: `fanwaave-mcp-server`
